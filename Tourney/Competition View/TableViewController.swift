...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        data = [CellData(image: UIImage(named: "BMX_Competition_1"), message: "", filter: "BMX_Competition_1"), CellData(image: UIImage(named: "BMX_Competition_2"), message: "", filter: "BMX_Competition_2")]
